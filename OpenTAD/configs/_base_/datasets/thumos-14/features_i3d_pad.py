...
annotation_path = "datasets/converted_annotations.json"
class_map = "datasets/category_idx.txt"
data_path = "datasets/features"
block_list = "datasets/missing_files.txt"
